...
- [로드 밸런서·오토스케일링·보안 그룹](aws/g06-load-balancer-autoscaling.md) — VPC 3-tier 보안 그룹(sg-alb·sg-web·sg-rds) 구성, ALB 생성·대상 그룹·헬스 체크, Auto Scaling(시작 템플릿·대상 추적 정책) 그룹 생성
