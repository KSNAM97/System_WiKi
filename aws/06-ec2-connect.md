...
![인스턴스에 연결 - EC2 Instance Connect 기본값](images/aws-06/connect-to-instance-console.png)
...
![브라우저 기반 터미널로 EC2 인스턴스 접속 완료](images/aws-06/browser-terminal-connected.png)
...
![SSH 접속 시 프라이빗 키 권한 경고](images/aws-06/ssh-unprotected-key-warning.png)
...
![chmod 700 적용 후 SSH 접속 성공](images/aws-06/ssh-connected-after-chmod.png)
