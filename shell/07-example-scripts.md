...
| --- | --- | --- |
| 1 | 변수 & 환경변수 | Q1~Q6 |
| 2 | Metacharacters | Q7~Q13 |
| 3 | expr & let | Q14~Q17 |
| 4 | exit & test | Q18~Q20 |
| 5 | 조건문 (if) | Q21~Q26 |
| 6 | 반복문 (for/while/until) | Q27~Q32 |
| 7 | 배열 (Array) | Q33~Q36 |
| 8 | 종합 스크립트 | Q37~Q40 |
| 9 | 위치 매개변수 | Q41~Q45 |
| 10 | case & read | Q46~Q49 |
| 11 | break·continue·폴링 | Q50~Q53 |
| 12 | 배열 심화 | Q54~Q56 |
| 13 | 🔴 실무 종합 심화 | Q57~Q60 |
...
> ⚠️ 실습 후 `userdel -r testA testB testC` 로 정리할 것.
...
> ⚠️ 실습 후 `rm -rf /project && groupdel devteam` 로 정리할 것.
...
### 최종 문제 2) .vimrc + 안전 alias 배포 스크립트
...
### 최종 문제 3) guest 계정 dotfile 배포 재실행 스크립트
